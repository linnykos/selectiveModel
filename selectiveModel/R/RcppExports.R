...
c_initial_theta <- function(y, v, w) {
    .Call(`_selectiveModel_c_initial_theta`, y, v, w)
}

c_basic_interval <- function(endpoints, theta) {
    .Call(`_selectiveModel_c_basic_interval`, endpoints, theta)
}
...
c_intersect_circle_tester <- function(a, b, center, radius) {
    .Call(`_selectiveModel_c_intersect_circle_tester`, a, b, center, radius)
}
...
c_euclidean_to_radian_tester <- function(center, radius, point) {
    .Call(`_selectiveModel_c_euclidean_to_radian_tester`, center, radius, point)
}
